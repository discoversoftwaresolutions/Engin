...
st.set_page_config(page_title="SimulAI - CAE & Simulation", layout="wide")
...
with tab2:
    ...
    st.image("https://upload.wikimedia.org/wikipedia/commons/4/4c/FEA_model_example.png", caption="Stress Distribution", use_column_width=True)
